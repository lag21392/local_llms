...
set "PROFILE=%~1"
if "%PROFILE%==" echo Uso: _start.bat 3070-qwen36 ^| 3070-qwen38 ^| 3070-next ^| 3070-qwen3 ^| 5070ti-qwen36 ^| 5070ti-qwen38 ^| 5070ti-next ^| 5070ti-qwen3
exit /b 1
...
if /i "%PROFILE%=="3070-qwen36" (
    ...
    set "PEN=0.0"
    set "REASON=on"
    set "EXTRA=--no-mmproj --chat-template-kwargs {\"reasoning_effort\":\"medium\"}"
    set "GPU_LABEL=RTX 3070 8GB"
    ...
    set "TITLE=Qwen3.6-35B UD-IQ3_XXS [3070 Q3]"
    ...
    set "TITLE=Qwen3.6-35B UD-IQ3_XXS [5070 Ti Q3]"
    set "MODEL=%MODEL_QWEN36_IQ3%"
...
start /b "" cmd /c ""%ROOT%\.venv\Scripts\litellm" --port %LITELLM_PORT% --config "%ROOT%\scripts\litellm-config.yaml" >nul 2>&1"

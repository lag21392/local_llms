...
case "$PROFILE" in
  3070-qwen36)
    ...
    ;;
  3070-qwen38)
    TITLE="Qwen3.8-27B UD-IQ2_XXS [3070]"
    MODEL="$MODEL_QWEN38_IQ2"
    CTX="$CTX_3070_QWEN38"
  ...
  3070-next)
    ...
    ;;
  3070-qwen3)
    TITLE="Qwen3-8B UD-IQ1_M [3070 Q3]"
    MODEL="$MODEL_QWEN3_IQ1"
    CTX="$CTX_3070_QWEN3"
    FIT_TARGET=500; FIT_CTX=4096; BATCH=1024; UBATCH=256
    TEMP=0.6; TOPP=0.95; PEN=0.0; REASON=auto
    EXTRA=""
  ...
  5070ti-qwen36)
    ...
    ;;
  5070ti-qwen38)
    TITLE="Qwen3.8-27B UD-IQ4_XS [5070 Ti]"
    MODEL="$MODEL_QWEN38_IQ4"
  ...
  5070ti-next)
    ...
    ;;
  5070ti-qwen3)
    TITLE="Qwen3-8B UD-IQ1_M [5070 Ti Q3]"
    MODEL="$MODEL_QWEN3_IQ1"
